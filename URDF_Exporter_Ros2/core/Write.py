...
def write_link_urdf(
    ...
    with open(file_name, mode="a") as f:
        ...
        for joint in joints_dict:
            ...
            links_xyz_dict[link.name] = joints_dict[joint][
                "xyz"
            ]  # do not use the inverted distance from Link
            link.make_link_xml()
            f.write(link.link_xml)
            f.write("\n")
...
def write_urdf(
    ...
    file_name = (
        save_dir + "/urdf/" + robot_name + "_macro.urdf.xacro"
...
def write_state_publisher_launch(package_name, robot_name, save_dir):
    ...
    file_text = launch_templates.get_state_publisher_launch_text(
        package_name, robot_name
    )
